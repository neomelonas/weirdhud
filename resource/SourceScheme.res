...
Scheme
{
	...
	BaseSettings
	{
		...
		Frame.BgColor					"40 40 40 100"
		Frame.OutOfFocusBgColor			"40 40 40 50"
	...
	Fonts
	{
		...
		"DefaultFixedOutline" //edited by INsane 2010 for small netgraph font on all screen sizes
		{
            ...
            {
                "name"         "uni 05_53" [$WINDOWS] // Standard is "Lucida Console" Options are "Microsoft Sans Serif" "Georgia" "Impact" "Arial MT" and the best for small = "Haettenschweiler" but is a MS office and Win7 font, can be downloaded, google "Haettenschweiler" and install in C:/Windows/Fonts
                "name"         "Lucida Console" [$X360]    //"Lucida Console"
